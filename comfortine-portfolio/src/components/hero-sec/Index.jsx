        ...
        <div className="pl-8 h-full">
          ...
          <p className="mt-3 w-[100%]">
            <span className="text-lg font-semibold text-tertiary dark:text-white-100">
              ...
              With a keen interest in software Integration with AI, I thrive on
              solving complex problems and creating efficient solutions. My goal
              is to continuously learn and grow in the tech field, contributing
              to projects that make a difference. Welcome to my portfolio!
            </span>
          </p>
          ...
          <div className="h-[15rem] w-[100%] flex flex-col items-center mt-4 gap-3">
            <div className="h-48 w-48 bg-white rounded-full overflow-hidden">
              <img src="/comphortine.jpeg" alt="Profile Pic" />
            </div>
